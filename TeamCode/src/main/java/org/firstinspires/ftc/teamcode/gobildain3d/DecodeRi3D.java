package org.firstinspires.ftc.teamcode.gobildain3d;
...
public class DecodeRi3D extends OpMode {
    ...
    public void init() {
        ...
        rightFrontDrive = hardwareMap.get(DcMotor.class, "right_front_drive");//1
        leftBackDrive = hardwareMap.get(DcMotor.class, "left_back_drive");//2
        rightBackDrive = hardwareMap.get(DcMotor.class, "right_back_drive");//3
        leftLauncher = hardwareMap.get(DcMotorEx.class, "left_launcher"); //1
        rightLauncher = hardwareMap.get(DcMotorEx.class, "right_launcher"); //2
        intake = hardwareMap.get(DcMotor.class, "intake"); //0
        leftFeeder = hardwareMap.get(CRServo.class, "left_feeder");//1
        rightFeeder = hardwareMap.get(CRServo.class, "right_feeder");//2
        diverter = hardwareMap.get(Servo.class, "diverter"); //0
